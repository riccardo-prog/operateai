...
const guardrails = [
  ...
  'Customized around your tone and lead flow',
];
...
export default function HumanReassurance() {
  return (
    <Section id="human" tone="muted">
      ...
      >
        Lead Engine does not replace the realtor. It protects the relationship
        by making sure every lead gets a fast, clear, and professional first
        response. The system handles the repetitive early-stage conversation so
        the agent steps in when the lead is actually ready for a real
        conversation.
      </SectionHeader>
