...
const metrics = [
  { label: 'Inquiries received', value: '48' },
  { label: 'Leads still in conversation', value: '12' },
...
export default function Reporting() {
  return (
    <Section id="reporting" tone="muted">
      <SectionHeader eyebrow="Reporting" title="See exactly where the money is moving.">
        You get a weekly summary of the part of your funnel most realtors
        never actually track. Inquiries received, replies sent, conversations
        started, appointments booked, and where leads went cold. Plus a
        dashboard you can open whenever you want to check on a conversation.
      </SectionHeader>
      ...
      <div className="mt-12 max-w-3xl mx-auto rounded-3xl bg-gradient-to-br from-accent-soft-from to-accent-soft-to p-5 sm:p-8 lg:p-10">
        <div className="rounded-2xl bg-bg-elevated border border-border-soft p-6 md:p-8 shadow-[0_1px_2px_rgba(10,10,11,0.04)]">
          <div className="flex items-center justify-between pb-5 mb-6 border-b border-border-soft">
            <div>
              <p className="text-sm font-semibold tracking-tight text-ink-primary">Weekly summary email</p>
              <p className="mt-0.5 text-xs text-ink-tertiary">Delivered every Monday morning</p>
            </div>
